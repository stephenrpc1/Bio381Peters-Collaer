...
#First step is to calculate an ANOVA comparing the initial groups to see if they are stastically different.  I will then visualize this using the reshuffled histograms
...
# The red lines on the  histograms represent the 95% confidence interval on the simulated data and the black line is the observed mean.  The fact that the black line is outside of the red line indicates that it is likely from a different population.
