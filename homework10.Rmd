...
A <- rnorm(n = 20, mean = 50, sd= 2.5) #make corresponding data for group A
B <- rnorm(n = 20, mean = 75, sd = 5)#make corresponding data for group B
C <- rnorm(n = 20, mean = 25, sd = 1)#make corresponding data for group C
